...
// HotNews function is used to send the hottest news in the USA from the newsapi.org
func (app *Application) HotNews(bot *tgbotapi.BotAPI, update *tgbotapi.Update) {
